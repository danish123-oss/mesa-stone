            ...
            <div className="w-full max-w-6xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    <div className="space-y-3">
                        <label className="block text-xl md:text-2xl font-medium text-white">
                            Who&apos;s reaching out? <span className="text-white/80">(Your full name)</span>
                        </label>
                        <input
                            type="text"
                            name="name"
                            ...
                            required
                            className="w-full border-0 border-b-2 border-white bg-transparent text-white text-lg py-3 focus:outline-none focus:border-white/60 transition-colors placeholder-white/50"
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-3">
                            <label className="block text-xl md:text-2xl font-medium text-white">
                                We want to reply to you <span className="text-white/80">(Your Email Address)</span>
                            </label>
                            <input
                                type="email"
                                name="email"
                        ...
                        <div className="space-y-3">
                            <label className="block text-xl md:text-2xl font-medium text-white">
                                Let&apos;s talk <span className="text-white/80">(Your Phone Number) [Optional]</span>
                            </label>
                            <input
                                type="tel"
                                name="phone"
                    ...
                    <div className="space-y-3">
                        <label className="block text-xl md:text-2xl font-medium text-white">
                            What&apos;s on your mind? <span className="text-white/80">(Your Message to us)</span>
                        </label>
                        <textarea
                            name="message"
                    ...
                    <div className="pt-4 flex justify-start">
                        <button
                            type="submit"
                            className="bg-white rounded-sm text-[#E0115F] px-12 py-4 text-xl font-semibold hover:bg-white/90 transition-colors duration-300 shadow-lg hover:shadow-xl"
                        >
                            Send Message
                        </button>
                    </div>
                ...
                <div className='bg-[#00688D] mt-6 px-12 py-8 w-fit rounded-lg flex flex-col items-center justify-center mx-auto'>
                    ...
                    <div className=" mt-8 flex justify-center items-center gap-8 md:gap-12">
                        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/80 transition-colors">
                            <svg className="lg:w-12 lg:h-12 w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="mt-16 -mb-8 flex justify-start items-center gap-8 md:gap-12">
                    <p className="text-white text-sm">
                        &copy; Mesa Stone  {new Date().getFullYear()}—Privacy Policy—Terms & Conditions
                    </p>
                </div>
            </div>
        </section>
